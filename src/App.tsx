...
function App() {
  ...
  const [color, setColor] = useState("#F6F8FF");
    ...
    <div className="App">
      <MainDiv>
        ...
        <HeaderDiv>
          ...
          >
            <HeaderText style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
              {!isDark ? "DARK" : "LIGHT"}
            </HeaderText>
            {!isDark ? (
        ...
        <SearchDiv style={{ backgroundColor: isDark ? "#1E2A47" : "#fefefe" }}>
          ...
          <ErrorMessage>{isError ? "Not Found" : null}</ErrorMessage>
          <SearchButton
            onClick={() => {
              requestUser();
              setActive(!active);
        ...
        >
          <ContentHeader>
            ...
            <UserHeaderDiv>
              <ContentHeaderName>
                <UserNameH1 style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
                  {data.name}
                </UserNameH1>
                <UserNameP style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
                  @{data.login}
                </UserNameP>
              </ContentHeaderName>
              <UserDate style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
                {data.created_at}
              </UserDate>
            </UserHeaderDiv>
          </ContentHeader>
          <UserBio
            opacity={data.bio === null ? "0.5" : "1"}
            style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}
          >
            {data.bio === null ? "Not Available" : data.bio}
          </UserBio>
          <ResultDiv
            style={{ backgroundColor: isDark ? "#141D2F" : "#F6F8FF" }}
          >
            <ReposDiv style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
              <ReposP style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
                Repos
              </ReposP>
              {data.public_repos}
            </ReposDiv>
            <FollowersDiv style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
              <ReposP style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
                Followers
              </ReposP>
              {data.followers}
            </FollowersDiv>
            <FollowingDiv style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
              <ReposP style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}>
                Following
              </ReposP>
              {data.following}
          ...
          <FooterDiv>
            <FooterDiv1>
              <LocationDiv>
                <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill={!isDark ? "#4b6a9b" : "#FFFFFF"}
                  />
                </svg>
                <LocationP
                  opacity={data.location === null ? "0.5" : "1"}
                  style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}
                >
              ...
              <LinkBlog>
                ...
                <LinkBlogP
                  opacity={data.html_url === null ? "0.5" : "1"}
                  style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}
                >
            ...
            <FooterDiv2>
              <Twitter>
                ...
                <TwitterP
                  opacity={data.twitter_username === null ? "0.5" : "1"}
                  style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}
                >
              ...
              <Company>
                ...
                <CompanyP
                  opacity={data.company === null ? "0.5" : "1"}
                  style={{ color: isDark ? "#FFFFFF" : "#4B6A9B" }}
                >
...
`;
const FollowersDiv = styled(ReposDiv)``;
const FollowingDiv = styled(ReposDiv)``;

const ReposP = styled.p`
  font-weight: 400;
  font-size: 11px;
  line-height: 16px;
  text-align: center;
...
const FooterDiv1 = styled.div`
  ...
  text-align: left;
`;
const FooterDiv2 = styled(FooterDiv1)`
  @media (min-width: 480px) {
    margin-left: 10px;
  }
`;
...
const LinkBlog = styled(LocationDiv)``;
const LocationP = styled(LinkBlogP)`
  margin-left: 25px;
`;
const Twitter = styled(LocationDiv)``;
const TwitterP = styled(LinkBlogP)``;
const Company = styled(LocationDiv)``;
const CompanyP = styled(LinkBlogP)``;
